...
def interact_with_cron():
    ...
    cm.clear_screen()
    print('This function allows you to chose when your computer tracks AO3 info.')
    print('Your computer will NOT track info if it is turned off.')
    print('Choose times, or set multiple times a day, that you think your computer')
    print('will be turned on. If the program tracks more than once in a day,')
    print('there\'s no harm done!')
    print('If your computer is not on during a scheduled tracking time, the')
    print('computer will wait until the next time.')
    print('There\'s no harm done!')
    print('So go crazy!')
    print('\n\n')
    while True:
        print('What would you like to do? After typing, hit Enter')
        print('View tracking times:                   Type "View"')
        print('Add a tracking time:                   Type "Add"')
        print('Remove a tracking time:                Type "Remove"')
        print('Change a tracking time:                Type "Change"')
        print('                   ~~~~~~~~~~             ')
